...
start cmd /K .\clientbayes.exe hospital2 127.0.0.1:2606 serverlist.txt %GOPATH%\src\github.com\4180122\distbayes\testdata\x2.txt %GOPATH%\src\github.com\4180122\distbayes\testdata\y2.txt h2 0&
