...
for /f "usebackq tokens=2 delims=:" %%f in (`ipconfig ^| findstr /c:"local IPv6 Address"`) do set NODENAME=%%f
...
%DBPATH%\clientbayes.exe %NODENAME% %LOCALADD%:12456 %SERVERADD% %XDATA% %YDATA% log
pause
